...
const Room s_room[room_count] =
{
    ...
    {L"Вы вошли в аптеку!",                                      7   }, //18
    {L"И снова уборная",                                        -1   }, //19
    {L"Вы спрыгнули в подсобку",                                 8   }, //20
    {L"Вы влители в склад",                                     -1   }, //21
    {L"Вы вошли в подвал",                                      10   }, //22
    {L"Вы приехали в тунель",                                   -1   }, //23
    {L"Вы прибежали к АЗС",                                      11  }, //24
    {L"Вы подошли к колонке",                                    3   }, //25
    {L"Вы вошли в мини-маркет",                                  12  }, //26
    ...
    {L"Вы пришли на парковку",                                   14  }, //31
    {L"Вы подошли к автобусу",                                   12  }, //32
    {L"Вы подошли к жыгули",                                     13  }, //33
    {L"Вы пришлы к запорожцу",                                   14  }, //34
    {L"Вы подошли к мерседесу",                                  -1  }, //35
    {L"Вы пришлы к ферари",                                      15  }, //36
};
...
// Комната Тип         Текст                               Результат
    ...
    {11, AT_HEAL,      L"Сказать что вы король",              6         , L"Прибежали крысы и дали вам отличный сыр"},
    ...
    {14, AT_MESSAGE,   L"Посмотреть телевизор",               0         , L"Новости: На парковке стало опаснее чем на заправке опасайтесь!"},
    ...
    {17, AT_LOOT,      L"Порыться в углях",                   7         , L""},
    ...
    {18, AT_GOTO_ROOM, L"Войти в комнату без дверей",         21        , L""},
    ...
    {22, AT_HEAL,      L"Выпеть воду с лужы",                  7        , L""},
    ...
    {25, AT_MESSAGE,   L"Спросить у бомжа про то как уехать", 0         , L"Говорять что на парковке остались целые машыны"},
    {25, AT_BUY,       L"Купить",                             9         , L""},
    ...
    {32, AT_USE_ITEM,  L"Залить бензин",                      83        , L"Вы залили бензин"},
    {32, AT_GOTO_ROOM, L"Вернуться",                          31        , L""},
     
    {33, AT_LOOT,      L"Осмотреть багажник",                 57        , L""},
